    ...
    <main className=" bg-white max-w-[400px] max-h-[800px] absolute w-full h-[100dvh] top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 overflow-hidden">
      <div className="absolute w-full h-full">
        ...
        <div className="absolute w-full h-72 bottom-[10%] left-1/2 -translate-x-1/2">
          ...
          <Image style={{width: "160px", height: "160px"}} src={cloud2} width={160} height={160} className="absolute right-[-48px] animate-cloud-left-right" alt="구름" />
        </div>
        {/* 하트 & 로고 */}
        ...
        <div className="absolute w-full h-56 bottom-[25%] max-h-sm:bottom-[20%]">
          ...
          <Image style={{width:"48", height: "48"}} src={choco2} className="absolute right-4 bottom-1/2 -translate-y-1/2 animate-choco-right-left" alt="초콜릿" />
