...
export default function Modal({ size = "sm", title, type = "card", children, value, maxLength, onChange }) {
        ...
        <div className="border-4 border-default rounded-lg overflow-hidden">
          <div className={`w-[343px] bg-popup-100 p-4 ${modalSize}`}>
            ...
            <div className="relative mt-3 h-40">
              ...
              {type === "card" && (
                <>
                  <textarea className="w-full h-36 text-3xl leading-normal bg-popup-100 absolute" placeholder="내용을 입력하세요." />
              ...
              {type === "single" && (
                <>
                  ...
                  <input
                    ...
                    value={value}
                    onChange={onChange}
                    className="text-center w-full h-10 text-3xl bg-popup-100 absolute top-1/2 transform -translate-y-10"
                  />
